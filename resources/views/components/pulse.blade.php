                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4 sm:gap-6">
                            ...
                            <a
                                ...
                                class="inline-flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800"
                            >
